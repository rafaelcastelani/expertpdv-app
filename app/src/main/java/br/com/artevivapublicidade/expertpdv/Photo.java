...
public class Photo extends DB {
    ...
    public List<Photo> find(String whereClause, String[] whereArgs, String groupBy, String having, String orderBy, String limit) {
    ...
    public Photo findByPath(String photoPath) {
    ...
    public List<Photo> findByNames(String[] photoNames) {
